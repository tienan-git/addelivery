...
public abstract class BaseService {
    ...
    protected <T> T callForNonJson(String resource, HttpMethod httpMethod, Object requestObjec,
            String twitterAuthorization, Class<T> responseClass) throws Exception {
        ...
        Gson gson = new Gson();
        if (requestObjec != null) {
            body = RequestBody.create(MediaType.parse("non-JSON"), gson.toJson(requestObjec));
            // System.out.println("body : " + gson.toJson(requestObjec));
        } else {
            body = RequestBody.create(MediaType.parse("non-JSON"), gson.toJson(null));
        }
