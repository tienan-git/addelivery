...
public class CodeMasterServiceImpl implements CodeMasterService {
	...
	public void getGoogleAreaList() {
		...
		for (GoogleAreaPrice googleAreaPrice : googleAreaPriceList) {
			...
			googleAreaUnitPriceDisplayList
					.add(Pair.of(googleAreaPrice.getAreaId(), googleAreaPrice.getUnitPriceDisplay()));
		}
	}
	...
	public void getFacebookAreaList() {
		...
		for (FacebookAreaPrice facebookAreaPrice : facebookAreaPriceList) {
			...
			facebookAreaUnitPriceClickList
					.add(Pair.of(facebookAreaPrice.getAreaId(), facebookAreaPrice.getUnitPriceClick()));
			facebookAreaUnitPriceDisplayList
					.add(Pair.of(facebookAreaPrice.getAreaId(), facebookAreaPrice.getUnitPriceDisplay()));
		}
	}
