...
public enum IssueAdtype implements CodeEnum<String> {
    ...
    GOOGLE("label google", "Google"), FACEBOOK("label faceBook", "FaceBook"), INSTAGRAM("label instagram", "Instagram"),
    DSP("label dsp", "FreakOut"), TWITTER("label twitter", "Twitter"), YAHOO("label yahoo", "Yahoo"),
    YOUTUBE("label youtube", "Youtube");
