 ...
 */
@Entity
@Table(name = "facebook_area_price")
public class FacebookAreaPrice extends BaseEntity {

    /** Facebook地域別単価ID */
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "facebook_area_price_id")
    Long facebookAreaPriceId;
    ...
    /** 
     * Returns the facebookAreaPriceId.
     * 
     * @return the facebookAreaPriceId
     */
    public Long getFacebookAreaPriceId() {
        return facebookAreaPriceId;
    }

    /** 
     * Sets the facebookAreaPriceId.
     * 
     * @param facebookAreaPriceId the facebookAreaPriceId
     */
    public void setFacebookAreaPriceId(Long facebookAreaPriceId) {
        this.facebookAreaPriceId = facebookAreaPriceId;
    }
