 ...
 */
@Entity
@Table(name = "youtube_location_report")
public class YoutubeLocationReport extends BaseEntity {

    /** Youtube地域別レポートID */
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "youtube_region_report_id")
    Long youtubeRegionReportId;
    ...
    /** 
     * Returns the youtubeRegionReportId.
     * 
     * @return the youtubeRegionReportId
     */
    public Long getYoutubeRegionReportId() {
        return youtubeRegionReportId;
    }

    /** 
     * Sets the youtubeRegionReportId.
     * 
     * @param youtubeRegionReportId the youtubeRegionReportId
     */
    public void setYoutubeRegionReportId(Long youtubeRegionReportId) {
        this.youtubeRegionReportId = youtubeRegionReportId;
    }
